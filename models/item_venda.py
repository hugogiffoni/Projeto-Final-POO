...
class ItemVenda:
    ...
    def __init__(
        ...
        # Atribuição direta aos atributos privados (não há setter público)
        self._id_item = id_item
        self._id_jogo = int(id_jogo)
        self._jogo = jogo
        # Estes dois usam setter (com validação)
        self.id_venda = id_venda
        self.quantidade = quantidade
        self.preco_unitario = preco_unitario

    # Factory method: criar ItemVenda a partir de um Jogo
    @classmethod  # 🆕 ESTAVA EM FALTA!
